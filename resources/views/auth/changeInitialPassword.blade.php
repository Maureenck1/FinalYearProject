<html>
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg" style="color:blue;">Change Your Initial Password To Proceed To LogIn.</p>
      ...
      <form action= "resettingPassword" method="post">
        ...
        <div class="form-group has-feedback">
                        ...
                        <input id="email" type="password" placeholder="Password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" required autocomplete="email" autofocus>
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>                        
        </div>
        <div class="form-group has-feedback">

                        <input id="password" placeholder="Retype Password" type="password" class="form-control @error('retypePassword') is-invalid @enderror" name="retypePassword" required >
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>                                           
        </div>        
        <div class="row">
          <div class="col-xs-6">
